...
var users = [
    { id: 1, username: 'francesco', password: 'test1', token: '123456789', email: 'francesco@example.com'}
  , { id: 2, username: 'alessandro', password: 'test2', token: 'abcdefghi', email: 'alessandro@example.com' }
];
